...
!function t(e, n, o) {
    ...
    3: [function (t, e, n) {
        var o = t("./svg-utilities"), i = t("./utilities"), s = function (t, e) {
            this.init(t, e)
        };
        s.prototype.init = function (t, e) {
            ...
            if (e || n) {
                if (e && (this.options.beforeZoom(this.getRelativeZoom(), this.computeRelativeZoom(t.a)) === !1 ? (t.a = t.d = this.activeState.zoom, e = !1) : (this.updateCache(t), this.options.onZoom(this.getRelativeZoom()))), n) {
                    var o = this.options.beforePan(this.getPan(), {x: t.e, y: t.f}), s = !1, r = !1;
    ...
    4: [function (t, e, n) {
        var o = t("./uniwheel"), i = t("./control-icons"), s = t("./utilities"), r = t("./svg-utilities"),
        ...
        l.prototype.init = function (t, e) {
            ...
            this.width = o.width, this.height = o.height, this.viewport = a(r.getOrCreateViewport(this.svg, this.options.viewportSelector), {
                svg: this.svg,
                width: this.width,
                height: this.height,
        ...
        var h = [], c = function (t, e) {
            ...
            for (var o = h.length - 1; o >= 0; o--) if (h[o].svg === n) return h[o].instance.getPublicInstance();
    ...
    5: [function (t, e, n) {
        ...
        document.documentMode && (i = "ie"), e.exports = {
            ...
            setCTM: function (t, e, n) {
                var o = this, s = "matrix(" + e.a + "," + e.b + "," + e.c + "," + e.d + "," + e.e + "," + e.f + ")";
                t.setAttributeNS(null, "transform", s), "transform" in t.style ? t.style.transform = s : "-ms-transform" in t.style ? t.style["-ms-transform"] = s : "-webkit-transform" in t.style && (t.style["-webkit-transform"] = s), "ie" === i && n && (n.parentNode.insertBefore(n, n), window.setTimeout(function () {
                    o.refreshDefsGlobal()
    ...
    6: [function (t, e, n) {
        e.exports = function () {
            ...
            function e(t, e) {
                for (var n = 0; n < c.length; n++) if (c[n].element === t && c[n].capture === e) return c[n].fn;
                return function () {
                }
            }

            function n(t, e) {
                for (var n = 0; n < c.length; n++) if (c[n].element === t && c[n].capture === e) return c.splice(n, 1)
            }
            ...
            function s(t, e, n) {
                o(t, u, e, n), "DOMMouseScroll" == u && o(t, "MozMousePixelScroll", e, n)
            }

            function r(t, e, n) {
                i(t, u, e, n), "DOMMouseScroll" == u && i(t, "MozMousePixelScroll", e, n)
            }
    ...
    7: [function (t, e, n) {
        ...
        e.exports = {
            extend: function (t, e) {
                t = t || {};
                for (var n in e) this.isObject(e[n]) ? t[n] = this.extend(t[n], e[n]) : t[n] = e[n];
                return t
                ...
                if ("svg" === e.tagName.toLowerCase()) n = e; else if ("object" === e.tagName.toLowerCase()) n = e.contentDocument.documentElement; else {
                ...
                var o, i, s, r = this, a = null, l = 0;
                n || (n = {});
                var u = function () {
                    l = n.leading === !1 ? 0 : r.now(), a = null, s = t.apply(o, i), a || (o = i = null)
                };
                return function () {
                    var h = r.now();
                    l || n.leading !== !1 || (l = h);
